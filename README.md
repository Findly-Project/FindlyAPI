...
*   **`tolerance = 1.0` (100%)**: Мягкий фильтр. Позволяет ценам отличаться вплоть до двух раз. Это похоже на ваше изначальное условие "разность не больше чем в 2 раза".
...
#### Когда использовать этот фильтр?

*   **Для поиска товаров "в одном ценовом сегменте"**, когда пользователь не знает точных границ цен.
*   **Для отсеивания аномально дорогих или дешевых товаров**, которые могут искажать восприятие каталога.
*   **Для улучшения пользовательского опыта** в категориях с большим разбросом цен, чтобы показывать пользователю более релевантные и сгруппированные предложения.
